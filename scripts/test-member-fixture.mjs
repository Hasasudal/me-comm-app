...
function execute(sql){
 execFileSync(process.execPath,['--import','./scripts/sites-env.mjs',wrangler,'d1','execute','DB','--local','--config',config,'--persist-to','.wrangler/state','--command',sql],{cwd:process.cwd(),stdio:'ignore'});
}
